...
<title>Aline Rosa | Sistema</title>
<link rel="icon" type="image/png" href="<?= base_url('assets/img/favicon.png');?>" />
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/style.css');?>" />
<script type="text/javascript" src="<?= base_url('assets/js/clockp.js');?>"></script>
<script type="text/javascript" src="<?= base_url('assets/js/clockh.js');?>"></script> 
...
ddaccordion.init({
	...
	togglehtml: ["suffix", "<img src=\"<?= base_url('assets/img/template/images/plus.gif');?>\" class=\"statusicon\" />", "<img src=\"<?= base_url('assets/img/template/images/minus.gif');?>\" class=\"statusicon\" />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <div class="menu">
                    <ul>
                    <li><a class="current" href="<?= base_url('home/home');?>">Home</a></li>
                    <li><a href="<?= base_url('alunos/listar');?>">Alunos<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="<?= base_url('alunos/listar');?>" title="Listar alunos">Listar</a></li>
                        <li><a href="<?= base_url('alunos/cadastro');?>" title="Cadastrar novo aluno">Cadastro</a></li>
                        <li><a href="<?= base_url('alunos/relatorio');?>" title="Relatório de alunos">Relatório</a></li>
                        </ul>
         ...
         <form action="" method="post" class="niceform">
                ...
                <fieldset>
                    <dl>
                        ...
                        <dd><input type="text" name="" id="" size="31" /></dd>
                    </dl>
                    <dl>
