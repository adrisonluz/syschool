...
class Contratos extends MY_Controller {
    ...
    public function cadastro() {
        ...
        $form .='</td>';
        $form .= '<td>';
        $form .= form_label('Carga horária:', '', array('for' => 'email'));
        $form .= form_input('carga_horaria', '', array('size' => 30, 'class' => 'formHora'));
        $form .='</td>';
        $form .= '</tr>';
        $form .= '<tr>';
        $form .= '<td>';
    ...
    public function editar() {
        ...
        $form .= '<td>';
        $form .= form_label('Carga horária:', '', array('for' => 'email'));
        $form .= form_input('carga_horaria', $dadosContrato['carga_horaria'], array('size' => 30, 'class' => 'formHora'));
        $form .='</td>';
        $form .= '</tr>';
        $form .= '<tr>';
        $form .= '<td>';
    ...
    public function imprimir() {
        ...
        $dadosResult = $this->contrato_model->listar($this->id, 'nome, cpf, endereco, bairro, cidade, curso, dias, data, horario, meses, valor_matricula, mensalidades, valor_mensalidade, carga_horaria,');
        $dados = $dadosResult[0];
        ...
        pdf($html, 'teste', 'Contrato ' . $dados['nome'], 'Visite nosso site: www.escoladancaalinerosa.com.br');
    }
