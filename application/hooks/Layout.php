...
$view = str_replace('{layout_content}', $output, $layout);

// Substitui o texto {title_for_layout} pelo valor de title em view.
$view = str_replace('{layout_title}', $title, $view);

// Links CSS.
$view = str_replace('{layout_css}', $css, $view);

// Links JS.
$view = str_replace('{layout_js}', $js, $view);
}
else
{
$view = $output;
